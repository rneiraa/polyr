...
| `nth(x, 2)` | base 1; negativos desde el final | igual | `n` es un argumento del análisis, no un índice de Python: con base 0, el código portado desde R daría el valor equivocado en silencio. |
